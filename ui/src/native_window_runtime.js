...
export function installNativeWindowOpen() {
  ...
  window.open = (url = '', target = '', features = '') => {
    ...
    /** @type {{[key: string]: unknown; title?: string; width?: number; height?: number; left?: number; top?: number; url?: string}} */
    const bootstrap = {}
...
export function installNativeMessageBridge() {
